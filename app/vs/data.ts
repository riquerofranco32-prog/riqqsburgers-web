...
export const competitors: Record<string, CompetitorData> = {
  olaclick: {
    ...
    tableRows: [
      { feature: "Precio", takefyy: "En pesos ARS", competitor: "En dólares USD" },
  ...
  pedix: {
    ...
    tableRows: [
      { feature: "Precio mensual", takefyy: "Desde $0 ARS", competitor: "Varía según plan" },
      { feature: "Plan gratuito", takefyy: true, competitor: false },
      { feature: "Pedidos por WhatsApp", takefyy: true, competitor: true },
  ...
  fudo: {
    ...
    tableRows: [
      { feature: "Precio", takefyy: "Desde $0 ARS", competitor: "Precio más alto" },
      { feature: "Plan gratuito", takefyy: true, competitor: false },
