...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: "article",
      images: [
        { url: "/opengraph-image", width: 1200, height: 630, alt: comp.title },
      ],
    },
    twitter: {
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 2,
          name: "Comparativas",
          item: "https://takefyy.com/vs",
        },
        {
          "@type": "ListItem",
          position: 3,
          name: `Takefyy vs ${comp.name}`,
          item: url,
        },
      ],
    },
  ...
  return (
    <>
      ...
      >
        ...
        {/* Comparison table */}
        <div
          style={{ maxWidth: 800, margin: "0 auto", padding: "64px 20px 0" }}
        >
          <h2
            style={{
              fontFamily: "var(--font-anton)",
        ...
        {/* Verdict */}
        <div
          style={{ maxWidth: 800, margin: "0 auto", padding: "0 20px 64px" }}
        >
          <div
            style={{
              background: "#0E1116",
