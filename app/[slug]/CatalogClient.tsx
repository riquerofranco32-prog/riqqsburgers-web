...
export default function CatalogClient({ restaurant }: { restaurant: Restaurant }) {
  ...
  return (
    ...
    >
      {/* ── Header ─────────────────────────────────────────────────────── */}
      <header
        className="pt-10 pb-6 px-4 flex flex-col items-center gap-4 border-b"
          ...
          >
            {currentCategory.items.map(item => {
              ...
              return (
                <div
                  key={item.id}
                  className="rounded-2xl overflow-hidden flex flex-col shadow-sm transition-all duration-200 hover:shadow-md"
                  style={{
                  ...
                  <div className="relative aspect-square">
                    ...
                    {item.badge && (
                      <span
                        ...
                        style={{ backgroundColor: item.badge === 'Popular' ? 'var(--secondary)' : '#4CAF50' }}
                      >
                        {item.badge}
                      </span>
                    )}
                    ...
                    <div className="flex items-center justify-between mt-auto pt-1">
                      ...
                      {qty === 0 ? (
                        <button
                          ...
                          className="w-8 h-8 rounded-full font-bold text-xl leading-none flex items-center justify-center transition-all active:scale-90 hover:opacity-90 text-white"
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <button
                            onClick={() => addItem(item)}
                            className="w-7 h-7 rounded-full font-bold flex items-center justify-center text-base leading-none active:scale-90 transition-all text-white"
                            style={{ backgroundColor: 'var(--accent)' }}
                          >
                            +
                          </button>
      ...
      {/* ── Sticky cart ────────────────────────────────────────────────── */}
      {totalItems > 0 && (
        <div className="fixed bottom-0 left-0 right-0 px-4 pb-6 pt-2 animate-slide-up">
          <div
            className="rounded-2xl flex items-center justify-between px-5 py-4"
            style={{
              backgroundColor: 'var(--surface)',
          ...
          >
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-3 rounded-xl font-bold text-sm text-white transition-all active:scale-95 hover:opacity-90"
