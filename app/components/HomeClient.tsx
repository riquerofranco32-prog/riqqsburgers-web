...
export default function HomeClient({
  ...
  return (
    ...
    >
      ...
      {/* ── FLOATING FOOD HERO ──────────────────────────────────────────────── */}
      <FloatingFoodHero
        title="Sabores que enamoran, a un pedido de distancia"
        description="Ayudamos a restaurantes a mostrar su menú y recibir pedidos directo por WhatsApp, sin comisiones de apps de delivery."
        images={[
          {
            src: "/images/hero-food/burger.png",
            alt: "Una hamburguesa deliciosa",
            className:
              "w-40 sm:w-56 md:w-64 lg:w-72 top-10 left-4 sm:left-10 md:top-20 md:left-20 animate-float",
          },
          {
            src: "/images/hero-food/empanadas.png",
            alt: "Una vaporera de bambú con empanadas al vapor",
            className:
              "w-28 sm:w-36 md:w-48 top-10 right-4 sm:right-10 md:top-16 md:right-16 animate-float",
          },
          {
            src: "/images/hero-food/pizza.png",
            alt: "Una porción de pizza",
            className:
              "w-32 sm:w-40 md:w-56 bottom-8 right-5 sm:right-10 md:bottom-16 md:right-20 animate-float",
          },
          {
            src: "/images/hero-food/albahaca.png",
            alt: "Una hoja de albahaca",
            className: "w-8 sm:w-12 top-1/4 left-1/3 animate-float",
          },
          {
            src: "/images/hero-food/tomate.png",
            alt: "Una rodaja de tomate",
